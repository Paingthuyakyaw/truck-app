                ...
                <Card.Body className="p-4">
                    ...
                    <View className="flex-row items-start justify-between border-b border-slate-100 pb-2.5 gap-x-3">
                        <View className="flex-1 min-w-0">
                            ...
                            <Text className="text-xs text-slate-400 mt-0.5" style={style}>
                                {labels.fuelType}: <Text className="font-semibold text-[#3F5F87]">{fuel}</Text>
                            </Text>
                        </View>
                        ...
                        <View className="shrink-0 bg-[#EAF1F8] px-2.5 py-1 rounded-md">
                            <Text className="text-xs font-bold text-[#3F5F87] font-mono tracking-wide" style={style}>
                                {plate}
                            </Text>
                        </View>
                    </View>
                    ...
                    <View className="mt-3 gap-y-3">
                        ...
                        <View className="flex-row justify-between gap-x-3">
                            <View className="flex-1 min-w-0">
                                <Text className="text-[10px] text-slate-400 font-bold uppercase tracking-wider" style={style}>
                                    {labels.chassisNo}
                                </Text>
                                <Text
                        ...
                        <View className="bg-[#EAF1F8]/30 border border-[#EAF1F8] rounded-lg p-2.5 flex-row justify-between gap-x-4">
                            <View className="flex-1 min-w-0">
                                <Text className="text-[9px] text-[#3F5F87] font-bold uppercase tracking-wide" style={style}>
                                    {labels.frontTire}
                                </Text>
                                <Text
